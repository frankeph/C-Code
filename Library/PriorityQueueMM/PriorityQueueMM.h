...
//--------------------------------------------------------------------------------------------------------------
//                                            Table of Content                   (Last Edited: 3rd of June 2018)
//--------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------
//                                                 NOTE                          (Last Edited: 3rd of June 2018)
//--------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------
//                                              Information                      (Last Edited: 3rd of June 2018)
//--------------------------------------------------------------------------------------------------------------
...
//enough supported item-count, I am confident this should change. Though right now, this data-structure should much
//more show my abilities when it comes to coding in the programming language C.




//--------------------------------------------------------------------------------------------------------------
//                                                  Details                      (Last Edited: 3rd of June 2018)
//--------------------------------------------------------------------------------------------------------------
...
//PriorityQueueMMSF:
// - RECOMMENDED USE: Integrated Systems, applications with real-time requirements, systems with low memory
...
//PriorityQueueMMSD:
// - RECOMMENDED USE: In cases in which the number of available items can not be determined.
// - REQUIRED CONFIGURATIONS: "INCLUDE_PRIORITYQUEUEMMAD"
// - DESCRIPTION:
//   This data-structure is a dynamic sized version of "PriorityQueueMMSF". This version is not optimized perfectly and was created
//	 as a version between "PriorityQueueMMSF" and "PriorityQueueMMAD", making the development of "PriorityQueueMMAD" much easier.
//	 Despite the imperfect optimization for this data-structure, this version should still be faster than "PriorityQueueMMAD" and
//	 require much less memory than "PriorityQueueMMAD".

//PriorityQueueMMAD:
// - RECOMMENDED USE: Similar to "PriorityQueueMMSD" but with the necessity to remove items other than the Min-
//   and the Max-Item
// - REQUIRED CONFIGURATIONS: "INCLUDE_PRIORITYQUEUEMMAD"
// - DESCRIPTION:
//   This data-structure is a dynamic sized version of "PriorityQueueMMAD". It contains all the functionality of "PriorityQueueMMAF"
//   while not being limited in the number of items it can hold at any point in time, unless memory space for said items can no longer
//   be allocated.
